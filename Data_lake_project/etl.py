...
def create_spark_session():
    ...
    # SPARK SESSION CODE TO READ AND WRITE LOCALLY
    # spark = SparkSession \
    #     .builder \
    ...
    # SPARK SESSION CODE TO READ AND WRITE ON S3
    spark = SparkSession\
        .builder\
